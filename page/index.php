    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="container col-md-11  ">
          ...
          <form action="index.php" method="post" class='aaa' onsubmit="startProgressBar()">
            ...
            <?php if (isset($image_path)) : ?>
              <?php if (isset($search_query)) : ?>
                <div class="mt-3">
                  ...
                  <img src="<?php echo $image_path; ?>" alt="Search Result Image" class="img-fluid" style="border:3px solid #000">
                </div>
              <?php else : ?>
                <div class="mt-3">
                  <h2>Search Result:</h2>
