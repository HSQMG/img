...
<body>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="container col-md-11" style="background-color: #39297b;">
        <style>
          * {
            margin: 0;
            padding: 0;
        ...
        <table class="table">
          ...
          <tbody>
            <?php while ($row = mysqli_fetch_assoc($result_select)) : ?>
              <tr>
                <td style="border: 1px solid #ccc;"><?php echo $row["search_query"]; ?></td>
                <td style="border: 1px solid #ccc;"><?php echo $row["timestamp"]; ?></td>
                <td style="border: 1px solid #ccc;"><img src="<?php echo $row["image_path"]; ?>" alt="Search Image"></td>
                <td style="border: 1px solid #ccc;"><a href="history.php?delete=<?php echo $row["search_id"]; ?>" class="btn btn-danger btn-sm">Delete</a></td>
              </tr>
            <?php endwhile; ?>
          </tbody>
        </table>
